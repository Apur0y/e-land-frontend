...
const testimonials = [
  { name: 'Rafiqul Islam', role: 'Real Estate Investor, Dhaka', avatar: 'RI', rating: 5, text: "Eland's AI analysis saved me from a bad investment. The risk report flagged a flood zone issue I completely missed. Now I use it before every purchase.", profit: 'Saved ৳40 Lakh' },
  ...
  { name: 'Farhana Khanam', role: 'NRB Investor, London', avatar: 'FK', rating: 5, text: "Managing investment from abroad is hard. Eland lets me analyze Bangladesh land remotely with complete data. The risk analysis is particularly valuable for NRBs.", profit: '৳2.8 Crore Portfolio' },
];
    ...
    <section ref={ref} className="py-24">
      <div className="page-container">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}} className="text-center mb-16">
          ...
          <p className="section-subtitle mx-auto">See how Eland is transforming land investment decisions.</p>
        </motion.div>
