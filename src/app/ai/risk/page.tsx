...
export const metadata: Metadata = { title: 'Risk Analysis – Land Investment Risk Assessment | Eland', description: 'Identify flood risks, legal issues, infrastructure gaps, and market risks for any land in Bangladesh using AI.' };
